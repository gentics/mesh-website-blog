...
teaser: We have just finished a major overhaul of our Elasticsearch integration with the release of Gentics Mesh 0.32.0. In this blog post I would like to share how we now handle synchronization between Gentics Mesh and Elasticsearch and also what approaches have been used before.
---
